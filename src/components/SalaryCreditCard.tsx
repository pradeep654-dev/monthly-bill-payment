          ...
          <div className="flex items-center space-x-2.5 min-w-0">
            ...
            <div className="min-w-0">
              <div className="flex items-center space-x-1.5 flex-wrap gap-y-1">
                <span className="text-[10px] font-black uppercase tracking-wider text-cyan-600 dark:text-cyan-400 whitespace-nowrap">
                  SBI Salary Engine
                </span>
                <span className="px-2 py-0.5 rounded-full bg-cyan-500/20 text-cyan-800 dark:text-cyan-300 text-[9px] font-black whitespace-nowrap shrink-0">
                  AUTO 1ST @ 11:55 PM
                </span>
              </div>
