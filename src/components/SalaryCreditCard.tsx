...
export const SalaryCreditCard: React.FC = () => {
  ...
  return (
    <>
      <div className="app-card p-5 relative overflow-hidden bg-gradient-to-br from-cyan-500/10 via-blue-500/5 to-transparent border border-cyan-500/20 dark:border-cyan-500/30 space-y-3">
        <div className="flex items-center justify-between pb-3 border-b border-cyan-500/15">
          <div className="flex items-center space-x-2.5">
            <div className="p-2 rounded-2xl bg-cyan-500 text-white shadow-md shadow-cyan-500/20">
            ...
            <div>
              <div className="flex items-center space-x-1.5">
                ...
                <span className="px-2 py-0.5 rounded-full bg-cyan-500/20 text-cyan-800 dark:text-cyan-300 text-[9px] font-black">
                  AUTO 1ST @ 11:55 PM
                </span>
              </div>
          ...
          <button
            ...
            className="flex items-center space-x-1 text-xs font-black text-blue-600 dark:text-blue-400 bg-blue-500/10 hover:bg-blue-500/20 px-2.5 py-1.5 rounded-xl transition-colors"
          >
            <Sliders className="w-3.5 h-3.5" />
            <span>Hike & Split</span>
          </button>
        </div>

        {/* 50/50 SBI -> HDFC Auto-Split Banner */}
        <div className="p-3 rounded-2xl bg-blue-500/10 border border-blue-500/25 flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <div className="text-xs font-extrabold text-slate-800 dark:text-slate-200">
              <span>Auto 50/50 Salary Split Engine</span>
          ...
          <span className="px-2 py-0.5 rounded-full bg-blue-500/20 text-blue-700 dark:text-blue-300 text-[10px] font-black shrink-0">
